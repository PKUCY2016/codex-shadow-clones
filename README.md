...
**最新版本：v0.3.0 · 2026-09-22**

[本次更新](#本次更新v030) · [更新安装](#更新到最新版) · [快速开始](#快速开始) · [直接交给 Codex](readme.txt) · [使用与排障](docs/USAGE.md) · [参考项目](docs/REFERENCES.md) · [实现边界](DESIGN.md)
...
配置导入会带入插件启用项，但不会复制整个插件缓存；符号链接 skills 不展开。它不是完整应用备份；历史汇总有延迟，不对运行中的界面热写入。
